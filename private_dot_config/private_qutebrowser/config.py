...
config.bind('O', 'cmd-set-text :open -r {url:pretty}')
# tabs
...
config.bind(',b', 'set colors.webpage.bg white')
config.bind(',m', 'set-cmd-text -s :spawn mpv {url}')
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/gurjal/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/gurjal/.local/share/qutebrowser/userscripts/*')
