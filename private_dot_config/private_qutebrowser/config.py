...
config.bind('mt', 'cmd-set-text -s :quickmark-load -t')
config.bind('mo', 'cmd-set-text -s :quickmark-load')
# jump mark
config.bind("'", 'cmd-set-text -s :jump-mark')
config.bind('"', 'cmd-set-text -s :set-mark')
# hints
...
config.bind('zt', 'cmd-set-text -s :tab-take')
config.bind('zb', ':set colors.webpage.bg white')
# theme
config.source('themes/rose-pine.py')
